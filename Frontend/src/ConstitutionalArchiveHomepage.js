      ...
      <header className="bg-gray-900 text-white py-4">
        <nav className="max-w-6xl mx-auto px-6 flex justify-between items-center">
          ...
          <ul className="hidden md:flex space-x-6">
            ...
            <li><a href="#" className="hover:text-blue-300">Browse Archive</a></li>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <nav className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="#" className="block bg-white rounded-lg p-6 text-center hover:shadow-md transition">
          ...
          <section className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <nav>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="#" className="hover:text-white">Usage Guidelines</a></li>
